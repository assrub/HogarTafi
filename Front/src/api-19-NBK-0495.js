...
export async function guardarMedicamentosApi(dni, medicamentos) {
    try {
        console.log("aca "  + medicamentos);
        const response = await fetch(`http://localhost:8080/medicamento/123456`, {
            method: "POST",
            headers: {
