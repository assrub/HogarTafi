...
function useRTGTransitionProps(_ref) {
  ...
  const handleEnter = (0, import_react13.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react13.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react13.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react13.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react13.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react13.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react13.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react13.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React9.forwardRef((_ref, ref) => {
  let {
    component: Component
  } = _ref, props = _objectWithoutPropertiesLoose3(_ref, _excluded2);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime6.jsx)(Component, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime7.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime7.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime7.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react15.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime8.jsx)("div", Object.assign({}, props)),
    ...
    onEntering,
    onEntered
  } = _ref, rest = _objectWithoutPropertiesLoose4(_ref, _excluded3);
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime8.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime8.jsx)(import_jsx_runtime9.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime10.jsxs)(import_jsx_runtime9.Fragment, {
...
var Fade = React12.forwardRef(({
  ...
  return (0, import_jsx_runtime11.jsx)(TransitionWrapper_default, {
    ...
    onEnter: handleEnter,
    childRef: children.ref,
    children: (status, innerProps) => React12.cloneElement(children, {
      ...innerProps,
...
var OffcanvasBody = React13.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasToggling = React14.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime13.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React14.cloneElement(children, {
      ...innerProps,
...
var AbstractModalHeader = React17.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  return (0, import_jsx_runtime16.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime15.jsx)(CloseButton_default, {
...
var OffcanvasHeader = React18.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
  ...
  return (0, import_jsx_runtime17.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var OffcanvasTitle = React19.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime19.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition(props) {
  return (0, import_jsx_runtime19.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React20.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react18.useCallback)((backdropProps) => (0, import_jsx_runtime19.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames10.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime19.jsx)("div", {
    ...dialogProps,
    ...props,
  ...
  return (0, import_jsx_runtime21.jsxs)(import_jsx_runtime20.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime19.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime19.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React21.forwardRef((props, ref) => {
  const context = (0, import_react19.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime22.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React22.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React23.forwardRef((props, ref) => {
  const {
  ...
  return (0, import_jsx_runtime24.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime24.jsx)(SelectableContext_default.Provider, {
      value: handleCollapse,
      children: (0, import_jsx_runtime24.jsx)(Component, {
        ref,
        ...controlledProps,
...
//# sourceMappingURL=chunk-M2L3XCTE.js.map
